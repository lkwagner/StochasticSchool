...
If you get stuck on this question, the next section might give a clue.
...
We can use this to analyze the differences between our wave functions:
\begin{itemize}
  \item
  ...
  \item
    ...
    This should explain why optimized uncorrelated wave functions tend to over-localized; can you use these results to explain this?
\end{itemize}
